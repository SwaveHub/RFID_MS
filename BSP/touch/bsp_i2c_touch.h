...
#define GTP_I2C_SCL_GPIO_CLK()             __HAL_RCC_GPIOB_CLK_ENABLE()

#define GTP_I2C_SDA_PIN                  GPIO_PIN_9                 
#define GTP_I2C_SDA_GPIO_PORT            GPIOF                    
#define GTP_I2C_SDA_GPIO_CLK()             __HAL_RCC_GPIOF_CLK_ENABLE()

/*复位引脚*/
#define GTP_RST_GPIO_PORT                GPIOF
#define GTP_RST_GPIO_CLK()                 __HAL_RCC_GPIOF_CLK_ENABLE()
#define GTP_RST_GPIO_PIN                 GPIO_PIN_11
/*中断引脚*/
#define GTP_INT_GPIO_PORT                GPIOF
#define GTP_INT_GPIO_CLK()                 __HAL_RCC_GPIOF_CLK_ENABLE()
#define GTP_INT_GPIO_PIN                 GPIO_PIN_10

#define GTP_INT_EXTI_LINE                EXTI_Line10
