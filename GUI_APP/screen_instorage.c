...
{
  if(obj==ta_item_name||obj==ta_layer_num||obj==ta_shelf_num)
  {
...
void lv_screen_instorage_start()
{
    ...
    lv_obj_set_pos(label_layer, 10, 100);
    ...
    lv_obj_set_pos(label_shelf, 10, 140);
